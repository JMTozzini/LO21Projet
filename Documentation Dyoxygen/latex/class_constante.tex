...
\hypertarget{class_constante_a62ac7c7b4f04706ef930728736ee45ae}{\index{Constante@{Constante}!cos\-Fonction@{cos\-Fonction}}
\index{cos\-Fonction@{cos\-Fonction}!Constante@{Constante}}
\subsubsection[{cos\-Fonction}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf Constante}\& Constante\-::cos\-Fonction (
\begin{DoxyParamCaption}
\item[{std\-::string}]{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}}\label{class_constante_a62ac7c7b4f04706ef930728736ee45ae}
...
Implemented in \hyperlink{class_entier_af49382e55f1a6c4d35472937eb4e8493}{Entier}, \hyperlink{class_rationnel_a0bfb204ddbbfa0b81db8d3b5fe46bdfa}{Rationnel}, \hyperlink{class_reel_a616d1bee36a89b7b260dfcf20def9b31}{Reel}, \hyperlink{class_complexe_afda6d543bb4195b86b367213659ffb91}{Complexe}, and \hyperlink{class_expression_abd5043859ed768c2230a5296f5ca1020}{Expression}.

\hypertarget{class_constante_a19851e590e8c40a4f3fddd3e78780a05}{\index{Constante@{Constante}!cube\-Fonction@{cube\-Fonction}}
\index{cube\-Fonction@{cube\-Fonction}!Constante@{Constante}}
\subsubsection[{cube\-Fonction}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Constante} \& Constante\-::cube\-Fonction (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_constante_a19851e590e8c40a4f3fddd3e78780a05}


Fonction permettant de calculer le Cube d'un nombre. 

\begin{DoxyReturn}{Returns}
Référence sur \hyperlink{class_constante}{Constante}. 
\end{DoxyReturn}
\hypertarget{class_constante_a52dd5fcfeb66534183e9419c222c6960}{\index{Constante@{Constante}!fact\-Fonction@{fact\-Fonction}}
\index{fact\-Fonction@{fact\-Fonction}!Constante@{Constante}}
\subsubsection[{fact\-Fonction}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Constante} \& Constante\-::fact\-Fonction (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_constante_a52dd5fcfeb66534183e9419c222c6960}


Fonction permettant de calculer la Factorielle. 
...
\hypertarget{class_constante_aa6b78608f1cac4f73fd6fc329827fc51}{\index{Constante@{Constante}!inv\-Fonction@{inv\-Fonction}}
\index{inv\-Fonction@{inv\-Fonction}!Constante@{Constante}}
\subsubsection[{inv\-Fonction}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Constante} \& Constante\-::inv\-Fonction (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_constante_aa6b78608f1cac4f73fd6fc329827fc51}


Fonction permettant de calculer l'Inverse d'un nombre. 

\begin{DoxyReturn}{Returns}
Référence sur \hyperlink{class_constante}{Constante}. 
\end{DoxyReturn}
\hypertarget{class_constante_ae5ab8d028c8f1f30adecd55e490abc02}{\index{Constante@{Constante}!ln\-Fonction@{ln\-Fonction}}
\index{ln\-Fonction@{ln\-Fonction}!Constante@{Constante}}
\subsubsection[{ln\-Fonction}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Constante} \& Constante\-::ln\-Fonction (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_constante_ae5ab8d028c8f1f30adecd55e490abc02}


Fonction permettant de calculer le Ln et le Log d'un nombre. 

\begin{DoxyReturn}{Returns}
Référence sur \hyperlink{class_constante}{Constante}. 
\end{DoxyReturn}
\hypertarget{class_constante_a9234f524cc1b97560236afe686c4767a}{\index{Constante@{Constante}!operator\%@{operator\%}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_constante_a9234f524cc1b97560236afe686c4767a}


Fonction permettant de gérer l'opération Modulo. 

\begin{DoxyReturn}{Returns}
Référence sur \hyperlink{class_constante}{Constante}. 
\end{DoxyReturn}
\hypertarget{class_constante_a4293c8632cc246b0e88285ae4afd2128}{\index{Constante@{Constante}!operator$\ast$@{operator$\ast$}}
\index{operator$\ast$@{operator$\ast$}!Constante@{Constante}}
\subsubsection[{operator$\ast$}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Constante} \& Constante\-::operator$\ast$ (
\begin{DoxyParamCaption}
\item[{{\bf Constante} $\ast$}]{c}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_constante_a4293c8632cc246b0e88285ae4afd2128}


Fonction permettant de surcharger l'opérateur de Multiplication. 

Surcharge permettant de réaliser l'opération $\ast$ pour les différentes constantes. Lors d'une opération c'est l'opérateur $\ast$ de \hyperlink{class_constante}{Constante} qui est appelé et qui délègue en fonction du type de \hyperlink{class_constante}{Constante} au surcharge des classes filles. \begin{DoxyReturn}{Returns}
Référence sur \hyperlink{class_constante}{Constante}. 
\end{DoxyReturn}
...
Fonction permettant de surcharger l'opérateur d'Addition. 
...
Fonction permettant de surcharger l'opérateur de Soustraction. 

Surcharge permettant de réaliser l'opération -\/ pour les différentes constantes. Lors d'une opération c'est l'opérateur -\/ de \hyperlink{class_constante}{Constante} qui est appelé et qui délègue en fonction du type de \hyperlink{class_constante}{Constante} au surcharge des classes filles. \begin{DoxyReturn}{Returns}
Référence sur \hyperlink{class_constante}{Constante}. 
\end{DoxyReturn}
\hypertarget{class_constante_a9be1827fd118f5a81cf10b509b64cfa7}{\index{Constante@{Constante}!operator/@{operator/}}
\index{operator/@{operator/}!Constante@{Constante}}
\subsubsection[{operator/}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Constante} \& Constante\-::operator/ (
\begin{DoxyParamCaption}
\item[{{\bf Constante} $\ast$}]{c}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_constante_a9be1827fd118f5a81cf10b509b64cfa7}


Fonction permettant de surcharger l'opérateur de Division. 

Surcharge permettant de réaliser l'opération / pour les différentes constantes. Lors d'une opération c'est l'opérateur / de \hyperlink{class_constante}{Constante} qui est appelé et qui délègue en fonction du type de \hyperlink{class_constante}{Constante} au surcharge des classes filles. \begin{DoxyReturn}{Returns}
Référence sur \hyperlink{class_constante}{Constante}. 
\end{DoxyReturn}
\hypertarget{class_constante_a6218e67aef6b06f29d37b112206d56c6}{\index{Constante@{Constante}!pow\-Fonction@{pow\-Fonction}}
\index{pow\-Fonction@{pow\-Fonction}!Constante@{Constante}}
\subsubsection[{pow\-Fonction}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Constante} \& Constante\-::pow\-Fonction (
\begin{DoxyParamCaption}
\item[{{\bf Constante} $\ast$}]{c}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_constante_a6218e67aef6b06f29d37b112206d56c6}


Fonction permettant de surcharger l'opérateur de Puissance. 

Surcharge permettant de réaliser l'opération Pow pour les différentes constantes. Lors d'une opération c'est l'opérateur Pow de \hyperlink{class_constante}{Constante} qui est appelé et qui délègue en fonction du type de \hyperlink{class_constante}{Constante} au surcharge des classes filles. \begin{DoxyReturn}{Returns}
Référence sur \hyperlink{class_constante}{Constante}. 
\end{DoxyReturn}
\hypertarget{class_constante_abf6fa0c8026ebcbf5c1a0d55b56f5d5b}{\index{Constante@{Constante}!sign\-Fonction@{sign\-Fonction}}
\index{sign\-Fonction@{sign\-Fonction}!Constante@{Constante}}
\subsubsection[{sign\-Fonction}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Constante} \& Constante\-::sign\-Fonction (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_constante_abf6fa0c8026ebcbf5c1a0d55b56f5d5b}


Fonction permettant de calculer l'Opposer. 

\begin{DoxyReturn}{Returns}
Référence sur \hyperlink{class_constante}{Constante}. 
\end{DoxyReturn}
\hypertarget{class_constante_a89475969e57f022a38cc3fb6617e3e29}{\index{Constante@{Constante}!sqr\-Fonction@{sqr\-Fonction}}
\index{sqr\-Fonction@{sqr\-Fonction}!Constante@{Constante}}
\subsubsection[{sqr\-Fonction}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Constante} \& Constante\-::sqr\-Fonction (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_constante_a89475969e57f022a38cc3fb6617e3e29}
...
Référence sur \hyperlink{class_constante}{Constante}. 
\end{DoxyReturn}
\hypertarget{class_constante_a94668c82b50be66607e701d989d5f725}{\index{Constante@{Constante}!sqrt\-Fonction@{sqrt\-Fonction}}
\index{sqrt\-Fonction@{sqrt\-Fonction}!Constante@{Constante}}
\subsubsection[{sqrt\-Fonction}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Constante} \& Constante\-::sqrt\-Fonction (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_constante_a94668c82b50be66607e701d989d5f725}
