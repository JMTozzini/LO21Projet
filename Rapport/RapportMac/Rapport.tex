...
\begin{figure}[H]
	\center
	\includegraphics[width=\width]{UMLProjetLO21v1.png}
	\caption{Diagramme de classe de la Calculatrice ‡ notation polonaise inversÈe}
\end{figure}
...
\begin{figure}[H]
	\center
	\includegraphics[width=\width]{diag_seq_1.png}
